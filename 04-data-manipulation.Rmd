...
A common number-to-string conversion task is formatting 5-digit American zip codes. Some zip codes begin with 0, but if stored as a numeric value, the 0 is dropped. 

```{r}
zip_codes <- c(03766, 03748, 03241, 03264)
zip_codes
```

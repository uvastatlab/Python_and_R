...
Python's relational operators can be used to compare arrays to single values or other arrays. The following operation returns an array containing `True` and `False` values. 

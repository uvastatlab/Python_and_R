...
\DecValTok{2001}\OperatorTok{{-}}\DecValTok{04}\OperatorTok{{-}}\DecValTok{12}
\end{Highlighting}
\end{Shaded}
...
\DecValTok{2022}\OperatorTok{{-}}\DecValTok{03}\OperatorTok{{-}}\DecValTok{02}
\end{Highlighting}
\end{Shaded}
...
\DecValTok{1981}\OperatorTok{{-}}\DecValTok{04}\OperatorTok{{-}}\DecValTok{12} \DecValTok{11}\NormalTok{:}\DecValTok{34}\NormalTok{:}\DecValTok{56}
...
\DecValTok{2021}\OperatorTok{{-}}\DecValTok{12}\OperatorTok{{-}}\DecValTok{06} \DecValTok{06}\NormalTok{:}\DecValTok{00}\NormalTok{:}\DecValTok{00}
...
\DecValTok{1981}\OperatorTok{{-}}\DecValTok{04}\OperatorTok{{-}}\DecValTok{12} \DecValTok{00}\NormalTok{:}\DecValTok{00}\NormalTok{:}\DecValTok{00}
\end{Highlighting}
\end{Shaded}
...
\DecValTok{2022}\OperatorTok{{-}}\DecValTok{03}\OperatorTok{{-}}\DecValTok{02} \DecValTok{23}\NormalTok{:}\DecValTok{32}\NormalTok{:}\FloatTok{31.995703}
...
\DecValTok{2023}\OperatorTok{{-}}\DecValTok{09}\OperatorTok{{-}}\DecValTok{03} \DecValTok{23}\NormalTok{:}\DecValTok{32}\NormalTok{:}\FloatTok{31.995703}
...
\DecValTok{2022}\OperatorTok{{-}}\DecValTok{03}\OperatorTok{{-}}\DecValTok{02} \DecValTok{18}\NormalTok{:}\DecValTok{32}\NormalTok{:}\FloatTok{31.995703}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{datetime.datetime(}\DecValTok{2022}\NormalTok{, }\DecValTok{3}\NormalTok{, }\DecValTok{2}\NormalTok{, }\DecValTok{23}\NormalTok{, }\DecValTok{32}\NormalTok{, }\DecValTok{31}\NormalTok{, }\DecValTok{995703}\NormalTok{)}
...
\DecValTok{1} \FloatTok{15.2}         \DecValTok{8} \FloatTok{275.8} \DecValTok{180}       \FloatTok{3.07}  \FloatTok{3.780} \FloatTok{18.0}      \DecValTok{0}  \DecValTok{0}    \DecValTok{3}    \DecValTok{3}     \DecValTok{0}
\DecValTok{2} \FloatTok{24.4}         \DecValTok{4} \FloatTok{146.7}  \DecValTok{62}       \FloatTok{3.69}  \FloatTok{3.190} \FloatTok{20.0}      \DecValTok{1}  \DecValTok{0}    \DecValTok{4}    \DecValTok{2}     \DecValTok{0}
\DecValTok{3} \FloatTok{33.9}         \DecValTok{4}  \FloatTok{71.1}  \DecValTok{65}       \FloatTok{4.22}  \FloatTok{1.835} \FloatTok{19.9}      \DecValTok{1}  \DecValTok{1}    \DecValTok{4}    \DecValTok{1}     \DecValTok{1}
\DecValTok{4} \FloatTok{21.4}         \DecValTok{4} \FloatTok{121.0} \DecValTok{109}       \FloatTok{4.11}  \FloatTok{2.780} \FloatTok{18.6}      \DecValTok{1}  \DecValTok{1}    \DecValTok{4}    \DecValTok{2}     \DecValTok{1}
\DecValTok{5} \FloatTok{17.3}         \DecValTok{8} \FloatTok{275.8} \DecValTok{180}       \FloatTok{3.07}  \FloatTok{3.730} \FloatTok{17.6}      \DecValTok{0}  \DecValTok{0}    \DecValTok{3}    \DecValTok{3}     \DecValTok{0}
\NormalTok{     am\_fac}
...
\NormalTok{   mpg cylinders  disp  hp axle\_ratio weight  qsec engine am gear carb am\_ch}
\DecValTok{1} \FloatTok{15.2}         \DecValTok{8} \FloatTok{275.8} \DecValTok{180}       \FloatTok{3.07}  \FloatTok{3.780} \FloatTok{18.00}      \DecValTok{0}  \DecValTok{0}    \DecValTok{3}    \DecValTok{3}     \DecValTok{0}
\DecValTok{2} \FloatTok{21.5}         \DecValTok{4} \FloatTok{120.1}  \DecValTok{97}       \FloatTok{3.70}  \FloatTok{2.465} \FloatTok{20.01}      \DecValTok{1}  \DecValTok{0}    \DecValTok{3}    \DecValTok{1}     \DecValTok{0}
\DecValTok{3} \FloatTok{18.7}         \DecValTok{8} \FloatTok{360.0} \DecValTok{175}       \FloatTok{3.15}  \FloatTok{3.440} \FloatTok{17.02}      \DecValTok{0}  \DecValTok{0}    \DecValTok{3}    \DecValTok{2}     \DecValTok{0}
...
\DecValTok{5} \FloatTok{22.8}         \DecValTok{4} \FloatTok{108.0}  \DecValTok{93}       \FloatTok{3.85}  \FloatTok{2.320} \FloatTok{18.61}      \DecValTok{1}  \DecValTok{1}    \DecValTok{4}    \DecValTok{1}     \DecValTok{1}
...
\includegraphics{_main_files/figure-latex/unnamed-chunk-268-3.pdf}
...
\includegraphics{_main_files/figure-latex/unnamed-chunk-285-5.pdf}
...
\includegraphics{_main_files/figure-latex/unnamed-chunk-286-7.pdf}
...
\includegraphics{_main_files/figure-latex/unnamed-chunk-290-2.pdf}
...
\includegraphics{_main_files/figure-latex/unnamed-chunk-303-3.pdf}
...
A two-sample proportion test can be done in Python using the \texttt{test\_proportions\_2indep()} function of the \texttt{statsmodels.stats.proportion} module. The two proportions being compared must be independent.

The first argument is the number of successes or occurances for the first proportion. The second argument is the number of total trials for the first group. The third and fourth arguments are the occurrences and total number of trials for the second group, respectively. Here we also specify the method for computing the confidence interval with the \texttt{method} argument, and how we compute the confidence interval with the \texttt{compare} argument.

\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}} \ImportTok{import}\NormalTok{ statsmodels.stats.proportion }\ImportTok{as}\NormalTok{ prop}
\OperatorTok{+} 
\OperatorTok{+}\NormalTok{ prop.test\_proportions\_2indep(}\DecValTok{210}\NormalTok{, }\DecValTok{747}\NormalTok{, }\DecValTok{122}\NormalTok{, }\DecValTok{661}\NormalTok{, method}\OperatorTok{=}\StringTok{\textquotesingle{}score\textquotesingle{}}\NormalTok{, compare}\OperatorTok{=}\StringTok{\textquotesingle{}diff\textquotesingle{}}\NormalTok{, return\_results}\OperatorTok{=}\VariableTok{True}\NormalTok{)}
\OperatorTok{\textless{}}\KeywordTok{class} \StringTok{\textquotesingle{}statsmodels.stats.base.HolderTuple\textquotesingle{}}\OperatorTok{\textgreater{}}
\NormalTok{statistic }\OperatorTok{=} \FloatTok{4.258048968887464}
\NormalTok{pvalue }\OperatorTok{=} \FloatTok{2.062187829962944e{-}05}
\NormalTok{compare }\OperatorTok{=} \StringTok{\textquotesingle{}diff\textquotesingle{}}
\NormalTok{method }\OperatorTok{=} \StringTok{\textquotesingle{}score\textquotesingle{}}
\NormalTok{variance }\OperatorTok{=} \FloatTok{0.0005142025147895945}
\NormalTok{alternative }\OperatorTok{=} \StringTok{\textquotesingle{}two{-}sided\textquotesingle{}}
\NormalTok{prop1\_null }\OperatorTok{=} \FloatTok{0.23579545454545456}
\NormalTok{prop2\_null }\OperatorTok{=} \FloatTok{0.23579545454545456}
\BuiltInTok{tuple} \OperatorTok{=}\NormalTok{ (}\FloatTok{4.258048968887464}\NormalTok{, }\FloatTok{2.062187829962944e{-}05}\NormalTok{)}
\NormalTok{diff }\OperatorTok{=} \FloatTok{0.09655566289363202}
\NormalTok{ratio }\OperatorTok{=} \FloatTok{1.5231417473171374}
\NormalTok{odds\_ratio }\OperatorTok{=} \FloatTok{1.7277223188936714}
\NormalTok{value }\OperatorTok{=} \DecValTok{0}
\end{Highlighting}
\end{Shaded}

TRIAL WITH SCIPY.STATS
...
\OperatorTok{+} \ImportTok{import}\NormalTok{ numpy }\ImportTok{as}\NormalTok{ np}
\OperatorTok{+} 
\OperatorTok{+}\NormalTok{ data }\OperatorTok{=}\NormalTok{ np.array([[}\DecValTok{210}\NormalTok{,(}\DecValTok{747}\OperatorTok{{-}}\DecValTok{210}\NormalTok{)],[}\DecValTok{122}\NormalTok{, (}\DecValTok{661}\OperatorTok{{-}}\DecValTok{122}\NormalTok{)]])}
\OperatorTok{+} 
\OperatorTok{+}\NormalTok{ stats.chi2\_contingency(data)}
\NormalTok{(}\FloatTok{17.611986459401233}\NormalTok{, }\FloatTok{2.70875657597463e{-}05}\NormalTok{, }\DecValTok{1}\NormalTok{, array([[}\FloatTok{176.13920455}\NormalTok{, }\FloatTok{570.86079545}\NormalTok{],}
\NormalTok{       [}\FloatTok{155.86079545}\NormalTok{, }\FloatTok{505.13920455}\NormalTok{]]))}
\end{Highlighting}
\end{Shaded}

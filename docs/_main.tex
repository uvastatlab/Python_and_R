...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\NormalTok{ mtcars[mtcars[}\StringTok{"mpg"}\NormalTok{] }\OperatorTok{\textgreater{}} \DecValTok{30}\NormalTok{][}\StringTok{"mpg"}\NormalTok{]}
\DecValTok{17}    \FloatTok{32.4}
\DecValTok{18}    \FloatTok{30.4}
\DecValTok{19}    \FloatTok{33.9}
\DecValTok{27}    \FloatTok{30.4}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\NormalTok{ mtcars[mtcars[}\StringTok{"mpg"}\NormalTok{] }\OperatorTok{\textgreater{}} \DecValTok{30}\NormalTok{].mpg}
\DecValTok{17}    \FloatTok{32.4}
\DecValTok{18}    \FloatTok{30.4}
\DecValTok{19}    \FloatTok{33.9}
\DecValTok{27}    \FloatTok{30.4}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\NormalTok{ df1 }\OperatorTok{=}\NormalTok{ mtcars[mtcars[}\StringTok{"mpg"}\NormalTok{] }\OperatorTok{\textgreater{}} \DecValTok{30}\NormalTok{][}\StringTok{"mpg"}\NormalTok{].values}
\OperatorTok{+}\NormalTok{ df2 }\OperatorTok{=}\NormalTok{ mtcars[mtcars[}\StringTok{"mpg"}\NormalTok{] }\OperatorTok{\textgreater{}} \DecValTok{30}\NormalTok{][[}\StringTok{"mpg"}\NormalTok{, }\StringTok{"cyl"}\NormalTok{]].values}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\NormalTok{ mtcars[mtcars[}\StringTok{"mpg"}\NormalTok{] }\OperatorTok{\textgreater{}} \DecValTok{30}\NormalTok{][mtcars[}\StringTok{"hp"}\NormalTok{] }\OperatorTok{\textless{}} \DecValTok{66}\NormalTok{]}
\NormalTok{     mpg  cyl  disp  hp  drat     wt   qsec  vs  am  gear  carb}
...
\DecValTok{2022}\OperatorTok{{-}}\DecValTok{0}\ErrorTok{3}\OperatorTok{{-}}\DecValTok{24}
\end{Highlighting}
\end{Shaded}
...
\DecValTok{2022}\OperatorTok{{-}}\DecValTok{0}\ErrorTok{3}\OperatorTok{{-}}\DecValTok{24} \DecValTok{0}\ErrorTok{1}\NormalTok{:}\DecValTok{16}\NormalTok{:}\FloatTok{57.044436}
...
\DecValTok{2023}\OperatorTok{{-}}\DecValTok{0}\ErrorTok{9}\OperatorTok{{-}}\DecValTok{25} \DecValTok{0}\ErrorTok{1}\NormalTok{:}\DecValTok{16}\NormalTok{:}\FloatTok{57.044436}
...
\DecValTok{2022}\OperatorTok{{-}}\DecValTok{0}\ErrorTok{3}\OperatorTok{{-}}\DecValTok{23} \DecValTok{20}\NormalTok{:}\DecValTok{16}\NormalTok{:}\FloatTok{57.044436}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{datetime.datetime(}\DecValTok{2022}\NormalTok{, }\DecValTok{3}\NormalTok{, }\DecValTok{24}\NormalTok{, }\DecValTok{1}\NormalTok{, }\DecValTok{16}\NormalTok{, }\DecValTok{57}\NormalTok{, }\DecValTok{44436}\NormalTok{)}
...
\NormalTok{   mpg cylinders  disp  hp axle\_ratio weight  qsec engine am gear carb am\_ch}
\DecValTok{1} \FloatTok{13.3}         \DecValTok{8} \FloatTok{350.0} \DecValTok{245}       \FloatTok{3.73}  \FloatTok{3.840} \FloatTok{15.41}      \DecValTok{0}  \DecValTok{0}    \DecValTok{3}    \DecValTok{4}     \DecValTok{0}
\DecValTok{2} \FloatTok{15.2}         \DecValTok{8} \FloatTok{304.0} \DecValTok{150}       \FloatTok{3.15}  \FloatTok{3.435} \FloatTok{17.30}      \DecValTok{0}  \DecValTok{0}    \DecValTok{3}    \DecValTok{2}     \DecValTok{0}
...
\DecValTok{4} \FloatTok{18.1}         \DecValTok{6} \FloatTok{225.0} \DecValTok{105}       \FloatTok{2.76}  \FloatTok{3.460} \FloatTok{20.22}      \DecValTok{1}  \DecValTok{0}    \DecValTok{3}    \DecValTok{1}     \DecValTok{0}
...
\NormalTok{    mpg cylinders  disp  hp axle\_ratio weight  qsec engine am gear carb am\_ch}
\DecValTok{3}  \FloatTok{22.8}         \DecValTok{4} \FloatTok{108.0}  \DecValTok{93}       \FloatTok{3.85}   \FloatTok{2.32} \FloatTok{18.61}      \DecValTok{1}  \DecValTok{1}    \DecValTok{4}    \DecValTok{1}     \DecValTok{1}
...
\DecValTok{14} \FloatTok{15.2}         \DecValTok{8} \FloatTok{275.8} \DecValTok{180}       \FloatTok{3.07}   \FloatTok{3.78} \FloatTok{18.00}      \DecValTok{0}  \DecValTok{0}    \DecValTok{3}    \DecValTok{3}     \DecValTok{0}
...
\DecValTok{31} \FloatTok{15.0}         \DecValTok{8} \FloatTok{301.0} \DecValTok{335}       \FloatTok{3.54}   \FloatTok{3.57} \FloatTok{14.60}      \DecValTok{0}  \DecValTok{1}    \DecValTok{5}    \DecValTok{8}     \DecValTok{1}
\NormalTok{      am\_fac}
\DecValTok{3}\NormalTok{     manual}
\DecValTok{5}\NormalTok{  automatic}
...
\OperatorTok{+} \ImportTok{import}\NormalTok{ pandas }\ImportTok{as}\NormalTok{ pd}
\OperatorTok{+} 
\OperatorTok{+}\NormalTok{ data }\OperatorTok{=}\NormalTok{ \{}\StringTok{"sex"}\NormalTok{: np.random.choice([}\StringTok{\textquotesingle{}i\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}f\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}m\textquotesingle{}}\NormalTok{], }\DecValTok{3}\NormalTok{),}
\OperatorTok{+} \StringTok{"wk1"}\NormalTok{: np.random.choice(}\BuiltInTok{range}\NormalTok{(}\DecValTok{20}\NormalTok{), }\DecValTok{3}\NormalTok{),}
\OperatorTok{+} \StringTok{"wk2"}\NormalTok{: np.random.choice(}\BuiltInTok{range}\NormalTok{(}\DecValTok{20}\NormalTok{), }\DecValTok{3}\NormalTok{),}
\OperatorTok{+} \StringTok{"wk3"}\NormalTok{: np.random.choice(}\BuiltInTok{range}\NormalTok{(}\DecValTok{20}\NormalTok{), }\DecValTok{3}\NormalTok{)\}}
\OperatorTok{+} 
\OperatorTok{+}\NormalTok{ df\_wide }\OperatorTok{=}\NormalTok{ pd.DataFrame(data)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\NormalTok{ pd.melt(df\_wide,}
\OperatorTok{+}\NormalTok{ id\_vars }\OperatorTok{=}\NormalTok{ [}\StringTok{"sex"}\NormalTok{],}
\OperatorTok{+}\NormalTok{ value\_vars }\OperatorTok{=}\NormalTok{ [}\StringTok{"wk1"}\NormalTok{, }\StringTok{"wk2"}\NormalTok{, }\StringTok{"wk3"}\NormalTok{],}
\OperatorTok{+}\NormalTok{ value\_name }\OperatorTok{=} \StringTok{"observations"}\NormalTok{)}
\NormalTok{  sex variable  observations}
\DecValTok{0}\NormalTok{   m      wk1            }\DecValTok{19}
\DecValTok{1}\NormalTok{   m      wk1            }\DecValTok{10}
\DecValTok{2}\NormalTok{   f      wk1             }\DecValTok{1}
\DecValTok{3}\NormalTok{   m      wk2             }\DecValTok{0}
\DecValTok{4}\NormalTok{   m      wk2            }\DecValTok{17}
\DecValTok{5}\NormalTok{   f      wk2            }\DecValTok{15}
\DecValTok{6}\NormalTok{   m      wk3             }\DecValTok{9}
\DecValTok{7}\NormalTok{   m      wk3             }\DecValTok{0}
\DecValTok{8}\NormalTok{   f      wk3            }\DecValTok{14}
\end{Highlighting}
\end{Shaded}
...
To reshape a DataFrame from long to wide, we can use the pandas \texttt{pivot()} and \texttt{pivot\_table()} functions.
...
\OperatorTok{+} \ImportTok{import}\NormalTok{ pandas }\ImportTok{as}\NormalTok{ pd}
\OperatorTok{+} 
\OperatorTok{+}\NormalTok{ data }\OperatorTok{=}\NormalTok{ \{}\StringTok{"sex"}\NormalTok{: np.random.choice([}\StringTok{\textquotesingle{}i\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}f\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}m\textquotesingle{}}\NormalTok{], }\DecValTok{9}\NormalTok{),}
\OperatorTok{+} \StringTok{"week"}\NormalTok{: np.random.choice(}\BuiltInTok{range}\NormalTok{(}\DecValTok{3}\NormalTok{), }\DecValTok{9}\NormalTok{),}
\OperatorTok{+} \StringTok{"observations"}\NormalTok{: np.random.choice(}\BuiltInTok{range}\NormalTok{(}\DecValTok{20}\NormalTok{), }\DecValTok{9}\NormalTok{)\}}
\OperatorTok{+} 
\OperatorTok{+}\NormalTok{ df\_long }\OperatorTok{=}\NormalTok{ pd.DataFrame(data)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}}\NormalTok{ df\_wide }\OperatorTok{=}\NormalTok{ pd.pivot\_table(df\_long,}
\OperatorTok{+}\NormalTok{ index}\OperatorTok{=}\StringTok{\textquotesingle{}sex\textquotesingle{}}\NormalTok{,}
\OperatorTok{+}\NormalTok{ columns}\OperatorTok{=}\StringTok{\textquotesingle{}week\textquotesingle{}}\NormalTok{,}
\OperatorTok{+}\NormalTok{ values}\OperatorTok{=}\StringTok{\textquotesingle{}observations\textquotesingle{}}\NormalTok{)}
\OperatorTok{+} 
\OperatorTok{+}\NormalTok{ df\_wide }
\NormalTok{week         }\DecValTok{0}    \DecValTok{1}    \DecValTok{2}
\NormalTok{sex                     }
\NormalTok{f     }\FloatTok{2.333333}\NormalTok{  NaN  NaN}
\NormalTok{i     }\FloatTok{7.500000}  \FloatTok{9.0}  \FloatTok{6.0}
\NormalTok{m          NaN  NaN  }\FloatTok{2.0}
\end{Highlighting}
\end{Shaded}
...
\OperatorTok{{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}
     \DecValTok{1}      \DecValTok{2}    \OperatorTok{{-}}\FloatTok{2.82} \FloatTok{0.001} \OperatorTok{{-}}\FloatTok{3.6858} \OperatorTok{{-}}\FloatTok{1.9542}   \VariableTok{True}
     \DecValTok{1}      \DecValTok{3}    \OperatorTok{{-}}\FloatTok{2.78} \FloatTok{0.001} \OperatorTok{{-}}\FloatTok{3.6458} \OperatorTok{{-}}\FloatTok{1.9142}   \VariableTok{True}
     \DecValTok{2}      \DecValTok{3}     \FloatTok{0.04}   \FloatTok{0.9} \OperatorTok{{-}}\FloatTok{0.8643}  \FloatTok{0.9443}  \VariableTok{False}
\OperatorTok{{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Warning}\SpecialCharTok{:}\NormalTok{ package }\StringTok{\textquotesingle{}ggeffects\textquotesingle{}}\NormalTok{ was built under R version }\DecValTok{4}\NormalTok{.}\FloatTok{1.2}
...
\includegraphics{_main_files/figure-latex/unnamed-chunk-338-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\SpecialCharTok{\textgreater{}}\NormalTok{ mod }\OtherTok{\textless{}{-}} \FunctionTok{glm}\NormalTok{(low }\SpecialCharTok{\textasciitilde{}}\NormalTok{ age }\SpecialCharTok{+}\NormalTok{ lwt }\SpecialCharTok{+}\NormalTok{ race }\SpecialCharTok{+} 
\SpecialCharTok{+}\NormalTok{              smoke }\SpecialCharTok{+}\NormalTok{ ptd }\SpecialCharTok{+}\NormalTok{ ht }\SpecialCharTok{+} 
\SpecialCharTok{+}\NormalTok{              ui }\SpecialCharTok{+}\NormalTok{ ftv, }
\SpecialCharTok{+}            \AttributeTok{data =}\NormalTok{ birthwt, }\AttributeTok{family =}\NormalTok{ binomial)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\SpecialCharTok{\textgreater{}}\NormalTok{ mod }\OtherTok{\textless{}{-}} \FunctionTok{glm}\NormalTok{(low }\SpecialCharTok{\textasciitilde{}}\NormalTok{ ., }\AttributeTok{data =}\NormalTok{ birthwt, }\AttributeTok{family =}\NormalTok{ binomial)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\SpecialCharTok{\textgreater{}} \FunctionTok{summary}\NormalTok{(mod)}

\NormalTok{Call}\SpecialCharTok{:}
\FunctionTok{glm}\NormalTok{(}\AttributeTok{formula =}\NormalTok{ low }\SpecialCharTok{\textasciitilde{}}\NormalTok{ age }\SpecialCharTok{+}\NormalTok{ lwt }\SpecialCharTok{+}\NormalTok{ race }\SpecialCharTok{+}\NormalTok{ smoke }\SpecialCharTok{+}\NormalTok{ ptd }\SpecialCharTok{+}\NormalTok{ ht }\SpecialCharTok{+}\NormalTok{ ui }\SpecialCharTok{+} 
\NormalTok{    ftv, }\AttributeTok{family =}\NormalTok{ binomial, }\AttributeTok{data =}\NormalTok{ birthwt)}

\NormalTok{Deviance Residuals}\SpecialCharTok{:} 
\NormalTok{    Min       1Q   Median       3Q      Max  }
\SpecialCharTok{{-}}\FloatTok{1.7038}  \SpecialCharTok{{-}}\FloatTok{0.8068}  \SpecialCharTok{{-}}\FloatTok{0.5008}   \FloatTok{0.8835}   \FloatTok{2.2152}  
...
\NormalTok{(Intercept)  }\FloatTok{0.82302}    \FloatTok{1.24471}   \FloatTok{0.661}  \FloatTok{0.50848}   
\NormalTok{age         }\SpecialCharTok{{-}}\FloatTok{0.03723}    \FloatTok{0.03870}  \SpecialCharTok{{-}}\FloatTok{0.962}  \FloatTok{0.33602}   
\NormalTok{lwt         }\SpecialCharTok{{-}}\FloatTok{0.01565}    \FloatTok{0.00708}  \SpecialCharTok{{-}}\FloatTok{2.211}  \FloatTok{0.02705} \SpecialCharTok{*} 
\NormalTok{raceblack    }\FloatTok{1.19241}    \FloatTok{0.53597}   \FloatTok{2.225}  \FloatTok{0.02609} \SpecialCharTok{*} 
\NormalTok{raceother    }\FloatTok{0.74069}    \FloatTok{0.46174}   \FloatTok{1.604}  \FloatTok{0.10869}   
\NormalTok{smoke1       }\FloatTok{0.75553}    \FloatTok{0.42502}   \FloatTok{1.778}  \FloatTok{0.07546}\NormalTok{ . }
\NormalTok{ptd1         }\FloatTok{1.34376}    \FloatTok{0.48062}   \FloatTok{2.796}  \FloatTok{0.00518} \SpecialCharTok{**}
\NormalTok{ht1          }\FloatTok{1.91317}    \FloatTok{0.72074}   \FloatTok{2.654}  \FloatTok{0.00794} \SpecialCharTok{**}
\NormalTok{ui1          }\FloatTok{0.68019}    \FloatTok{0.46434}   \FloatTok{1.465}  \FloatTok{0.14296}   
\NormalTok{ftv1        }\SpecialCharTok{{-}}\FloatTok{0.43638}    \FloatTok{0.47939}  \SpecialCharTok{{-}}\FloatTok{0.910}  \FloatTok{0.36268}   
\NormalTok{ftv2}\SpecialCharTok{+}        \FloatTok{0.17901}    \FloatTok{0.45638}   \FloatTok{0.392}  \FloatTok{0.69488}   
\SpecialCharTok{{-}{-}{-}}
\NormalTok{Signif. codes}\SpecialCharTok{:}  \DecValTok{0} \StringTok{\textquotesingle{}***\textquotesingle{}} \FloatTok{0.001} \StringTok{\textquotesingle{}**\textquotesingle{}} \FloatTok{0.01} \StringTok{\textquotesingle{}*\textquotesingle{}} \FloatTok{0.05} \StringTok{\textquotesingle{}.\textquotesingle{}} \FloatTok{0.1} \StringTok{\textquotesingle{} \textquotesingle{}} \DecValTok{1}

\NormalTok{(Dispersion parameter }\ControlFlowTok{for}\NormalTok{ binomial family taken to be }\DecValTok{1}\NormalTok{)}

\NormalTok{    Null deviance}\SpecialCharTok{:} \FloatTok{234.67}\NormalTok{  on }\DecValTok{188}\NormalTok{  degrees of freedom}
\NormalTok{Residual deviance}\SpecialCharTok{:} \FloatTok{195.48}\NormalTok{  on }\DecValTok{178}\NormalTok{  degrees of freedom}
\NormalTok{AIC}\SpecialCharTok{:} \FloatTok{217.48}
...
\begin{Shaded}
\begin{Highlighting}[]
\SpecialCharTok{\textgreater{}} \FunctionTok{exp}\NormalTok{(}\FunctionTok{coef}\NormalTok{(mod)[}\StringTok{"ptd1"}\NormalTok{])}
\NormalTok{    ptd1 }
\FloatTok{3.833443} 
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\SpecialCharTok{\textgreater{}} \FunctionTok{exp}\NormalTok{(}\FunctionTok{confint}\NormalTok{(mod)[}\StringTok{"ptd1"}\NormalTok{,])}
    \FloatTok{2.5} \SpecialCharTok{\%    97.5 \%} 
 \FloatTok{1.516837} \FloatTok{10.128974} 
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\SpecialCharTok{\textgreater{}} \CommentTok{\# install.packages("ggeffects")}
\ErrorTok{\textgreater{}} \FunctionTok{library}\NormalTok{(ggeffects)}
\SpecialCharTok{\textgreater{}} \FunctionTok{plot}\NormalTok{(}\FunctionTok{ggpredict}\NormalTok{(mod, }\AttributeTok{terms =} \StringTok{"ptd"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}

\includegraphics{_main_files/figure-latex/unnamed-chunk-346-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\SpecialCharTok{\textgreater{}} \FunctionTok{plot}\NormalTok{(}\FunctionTok{ggpredict}\NormalTok{(mod, }\AttributeTok{terms =} \StringTok{"lwt"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}

...
\DecValTok{2} \FloatTok{16.4}         \DecValTok{8} \FloatTok{275.8} \DecValTok{180}       \FloatTok{3.07}  \FloatTok{4.070} \FloatTok{17.40}      \DecValTok{0}  \DecValTok{0}    \DecValTok{3}    \DecValTok{3}     \DecValTok{0}
\DecValTok{3} \FloatTok{15.2}         \DecValTok{8} \FloatTok{304.0} \DecValTok{150}       \FloatTok{3.15}  \FloatTok{3.435} \FloatTok{17.30}      \DecValTok{0}  \DecValTok{0}    \DecValTok{3}    \DecValTok{2}     \DecValTok{0}
\DecValTok{4} \FloatTok{18.7}         \DecValTok{8} \FloatTok{360.0} \DecValTok{175}       \FloatTok{3.15}  \FloatTok{3.440} \FloatTok{17.02}      \DecValTok{0}  \DecValTok{0}    \DecValTok{3}    \DecValTok{2}     \DecValTok{0}
...
\includegraphics{_main_files/figure-latex/unnamed-chunk-250-3.pdf}
...
\includegraphics{_main_files/figure-latex/unnamed-chunk-264-2.pdf}
...
Descriptive statistics objects have attributes such as \texttt{mean} and \texttt{std} (standard deviation). Below we print the mean and standard deviation of each group. We also round the standard deviation to three decimal places.

\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textgreater{}} \BuiltInTok{print}\NormalTok{(\{}\StringTok{"control mean"}\NormalTok{:control.mean, }\StringTok{"std"}\NormalTok{:}\BuiltInTok{round}\NormalTok{(control.std, }\DecValTok{3}\NormalTok{)\})}
\NormalTok{\{}\StringTok{\textquotesingle{}control mean\textquotesingle{}}\NormalTok{: }\FloatTok{80.4}\NormalTok{, }\StringTok{\textquotesingle{}std\textquotesingle{}}\NormalTok{: }\FloatTok{3.844}\NormalTok{\}}
\OperatorTok{\textgreater{}} \BuiltInTok{print}\NormalTok{(\{}\StringTok{"treated mean"}\NormalTok{:treated.mean, }\StringTok{"std"}\NormalTok{: }\BuiltInTok{round}\NormalTok{(treated.std, }\DecValTok{3}\NormalTok{)\})}
\NormalTok{\{}\StringTok{\textquotesingle{}treated mean\textquotesingle{}}\NormalTok{: }\FloatTok{85.2}\NormalTok{, }\StringTok{\textquotesingle{}std\textquotesingle{}}\NormalTok{: }\FloatTok{3.331}\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{_main_files/figure-latex/unnamed-chunk-277-3.pdf}

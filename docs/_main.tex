...
\hypersetup{
  ...
  pdfauthor={Clay Ford, Jacob Goldstein-Greenwood, Samantha Lomuscio},
  hidelinks,
...
\title{Python and R}
\author{Clay Ford, Jacob Goldstein-Greenwood, Samantha Lomuscio}
\date{2021-09-29}
...
\DecValTok{4} \FloatTok{15.0}         \DecValTok{8} \FloatTok{301.0} \DecValTok{335}       \FloatTok{3.54}  \FloatTok{3.570} \FloatTok{14.60}      \DecValTok{0}  \DecValTok{1}    \DecValTok{5}    \DecValTok{8}     \DecValTok{1}

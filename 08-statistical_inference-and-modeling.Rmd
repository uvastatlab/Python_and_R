...
# Dependent variable (endogenous variable in documentation)
data_endog = birthwt["low"].values

# Independent variables (exogenous variable in documentation)
data_exog = birthwt.drop(['low'], axis = 1)
data_exog = pd.get_dummies(data_exog, columns=['race','ftv'], drop_first=True)

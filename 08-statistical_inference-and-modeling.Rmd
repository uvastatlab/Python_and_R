...
A two-sample proportion test can be carried out in Python using the `test_proportions_2indep()` function from the `statsmodels.stats.api` module. The two proportions being compared must be independent.
